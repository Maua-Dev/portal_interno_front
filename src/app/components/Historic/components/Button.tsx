...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantsStyle: Record<VariantTypes, string> = {
      default:
        'flex flex-row items-center justify-center gap-2 outline-none rounded-sm bg-skin-secundary px-4 py-2 font-semibold duration-150 ease-in hover:bg-skin-fill',
