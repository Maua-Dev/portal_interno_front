...
export default function ActionModal({ action }: { action?: Action }) {
  ...
  return (
    <div
      className={`flex h-full w-full transform items-center justify-center overflow-x-hidden overflow-y-scroll py-24 pt-[50rem] transition-all duration-200 sm:pt-24 lg:h-dvh lg:py-12 lg:pt-24 ${
        isUpdateModal
