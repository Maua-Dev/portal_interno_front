...
export default function NotificationIcon({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`-right-1 -top-1 flex h-4 w-4  flex-row items-center justify-center rounded-full bg-red-600 text-sm text-white ${
          notificationCount === 0 ? 'hidden' : 'absolute'
        }`}
      >
        {displayedCount}
      </div>
