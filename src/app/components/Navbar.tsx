...
export default function Navbar() {
  ...
  return (
    <div
      className={`fixed z-40 flex h-screen transform flex-col items-center gap-12 overflow-x-hidden bg-white px-4 py-10 drop-shadow-md transition-all duration-200 ease-in-out ${
        hover ? 'w-56' : 'w-28'
      }`}
      onMouseOver={() => setHover(true)}
      onMouseLeave={() => setHover(false)}
    >
      <img src={logo} alt="Logo da Dev. Community Mauá" className="h-14 w-16" />
